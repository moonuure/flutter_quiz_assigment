...
import '../quran/quranQuestion_model.dart';
import 'package:google_fonts/google_fonts.dart';

class HollyQuranQuiz extends StatefulWidget {
  HollyQuranQuiz({super.key});

  @override
  State<HollyQuranQuiz> createState() => _QuizPageState();
}

class _QuizPageState extends State<HollyQuranQuiz> {
  final user = FirebaseAuth.instance.currentUser!;

  List<QuranQues> questionList = getQuranQues();
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              questionList[currentQIndex].qurantQuestionText,
