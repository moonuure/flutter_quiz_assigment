...
import '../flutterQuiz/flutterQuestion_model.dart';
import 'package:google_fonts/google_fonts.dart';

class FlutterQuizz extends StatefulWidget {
  FlutterQuizz({super.key});

  @override
  State<FlutterQuizz> createState() => _QuizPageState();
}

class _QuizPageState extends State<FlutterQuizz> {
  final user = FirebaseAuth.instance.currentUser!;

  List<FlutterQues> questionList = getFlutterQues();
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              questionList[currentQIndex].flutQuestionText,
