...
import 'mtQuestion_model.dart';
import 'package:google_fonts/google_fonts.dart';

class MTQuizQues extends StatefulWidget {
  MTQuizQues({super.key});

  @override
  State<MTQuizQues> createState() => _QuizPageState();
}

class _QuizPageState extends State<MTQuizQues> {
  final user = FirebaseAuth.instance.currentUser!;

  List<MindTestQuestions> questionList = getMTQues();
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              questionList[currentQIndex].mTQuesText,
